...
// UpdateStatusMessage Updates the status message of the bot
func UpdateStatusMessage(s *discordgo.Session) {
	...
	s.UpdateStatus(0, ">btc help | $"+data["data"]["amount"])
}

// BitcoinBotHandler Processes incoming messages
func BitcoinBotHandler(s *discordgo.Session, m *discordgo.MessageCreate) {
	go UpdateStatusMessage(s)
...
func main() {
	...
	discord.AddHandler(BitcoinBotHandler)
